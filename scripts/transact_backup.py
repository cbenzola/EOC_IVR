...
conf = yaml.load(open('scripts/defines.yml'),Loader=yaml.FullLoader)
...
sql_drop = "DROP TABLE IF EXISTS transact;"

# Declare Create Statement #
sql_create = '''CREATE TABLE `transact` (
...
update = 'UPDATE transact SET SS_NO = replace(SS_NO, "-", "")'
